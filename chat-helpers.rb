...
module ChatHelpers
  ...
  LC_TEAM_URL = "https://gist.githubusercontent.com/NotBlizzard/0289a7efb96d1eea2d29/raw/36d28588ef61bd2bc57cc9eb471519aa862e804e/gistfile1.txt"
  OU_TEAM_URL = "https://gist.githubusercontent.com/NotBlizzard/e5e367d41e6894a8edd3/raw/0ffdcee8911d0e11c0cff9ba3c234cb93c8a29f6/team"
  UBERS_TEAM_URL = "https://gist.githubusercontent.com/NotBlizzard/06870af3a26023d55bf6/raw/8f6b58f0de4bd39c02d4e35e47e03a250349782f/gistfile1.txt"
  ...
  UBERS_TEAM = Faraday.get(UBERS_TEAM_URL).body
  OU_TEAM = Faraday.get(OU_TEAM_URL).body
  UU_TEAM = Faraday.get(UU_TEAM_URL).body
  LC_TEAM = Faraday.get(LC_TEAM_URL).body
